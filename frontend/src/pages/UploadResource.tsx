...
import { uploadResourceData } from "../services/uploadService";
        ...
        <div className="max-w-4xl mx-auto px-6 py-32">
          ...
          <div className="mb-12">
            ...
            <p className="text-xl text-gray-400 font-light">
              Share your knowledge with the community. Upload books or study
              notes to help others learn.
            </p>
          </div>
          ...
          <div className="flex gap-4 mb-8">
            <button
              ...
              className={`flex-1 py-4 px-6 rounded-xl border-2 transition-all duration-300 flex items-center justify-center gap-3 ${
                resourceType === "book"
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label className="block text-sm font-bold uppercase tracking-widest text-gray-400 mb-2">
                {resourceType === "book" ? "Author" : "Created By"}{" "}
              ...
              <input
                ...
                onChange={handleInputChange}
                placeholder={`Enter ${
                  resourceType === "book" ? "author" : "creator"
                } name`}
                required
                className="w-full bg-[#0a0a0a] border border-white/10 rounded-xl px-4 py-3 text-white placeholder:text-gray-600 focus:border-blue-500 focus:outline-none transition-colors"
              />
            ...
            <div>
              <label className="block text-sm font-bold uppercase tracking-widest text-gray-400 mb-2">
                {resourceType === "book" ? "Book" : "Note"} File{" "}
                <span className="text-red-500">*</span>
              </label>
              <div className="relative">
                ...
                >
                  ...
                  <span className="text-gray-400">
                    {formData.file
                      ? formData.file.name
                      : "Click to upload file (PDF, DOC, PPT, etc.)"}
                  </span>
                </label>
                {formData.file && (
                  <button
                ...
                >
                  ...
                  <span className="text-gray-400">
                    {formData.coverImage
                      ...
                      : "Click to upload cover image (JPG, PNG, etc.)"}
                  </span>
                </label>
                {formData.coverImage && (
                  <button
            ...
            <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50">
              <div className="bg-[#0a0a0a] border border-green-500/20 rounded-2xl p-8 max-w-md mx-4 text-center">
                ...
                <p className="text-gray-400">
                  Your {resourceType} has been uploaded successfully.
                  Redirecting...
                </p>
              </div>
            </div>
