...
const ManageResources = () => {
    ...
    const [resources, setResources] = useState<Resource[]>([
        { id: '1', title: 'Modern Physics', type: 'book', category: 'Physics', status: 'active', downloads: 124, dateAdded: 'Jan 15, 2024' },
        { id: '2', title: 'React Hooks Guide', type: 'note', category: 'Computer Science', status: 'active', downloads: 542, dateAdded: 'Feb 10, 2024' },
        { id: '3', title: 'Ancient Civilizations', type: 'book', category: 'History', status: 'inactive', downloads: 89, dateAdded: 'Mar 05, 2024' },
        { id: '4', title: 'Calculus III Notes', type: 'note', category: 'Mathematics', status: 'active', downloads: 215, dateAdded: 'Mar 20, 2024' },
    ]);
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-12">
            {/* Search & Filters - Human Design Spacing */}
            ...
            {/* Resource Grid/List - Opinionated "Crafted" Table */}
