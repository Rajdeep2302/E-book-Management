        ...
        >
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="relative hidden md:block" ref={userMenuRef}>
                  <button
                    ...
                    className="flex items-center justify-center w-10 h-10 rounded-full bg-white/[0.05] border border-white/10 text-white/70 hover:bg-white hover:text-black hover:border-white transition-all duration-300 active:scale-90 group/user relative"
                  >
          ...
          <div className={`md:hidden overflow-hidden transition-all duration-500 ${isOpen ? 'max-h-[500px] opacity-100' : 'max-h-0 opacity-0'}`}>
            <div className="p-6 space-y-4 border-t border-white/5 bg-black/20">
              {navItems.map((item) => (
                <a key={item.name} href={item.href} className="flex items-center justify-between group/mob">
